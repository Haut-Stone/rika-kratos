...
const (
	...
	Demo_HttpListDemo_FullMethodName = "/api.helloworld.v1.Demo/HttpListDemo"
)
...
type DemoClient interface {
	...
	HttpListDemo(ctx context.Context, in *ListDemoRequest, opts ...grpc.CallOption) (*ListDemoRequest, error)
}
...
func (c *demoClient) HttpListDemo(ctx context.Context, in *ListDemoRequest, opts ...grpc.CallOption) (*ListDemoRequest, error) {
	out := new(ListDemoRequest)
	err := c.cc.Invoke(ctx, Demo_HttpListDemo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServer) HttpListDemo(context.Context, *ListDemoRequest) (*ListDemoRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HttpListDemo not implemented")
}
...
func _Demo_HttpListDemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDemoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).HttpListDemo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Demo_HttpListDemo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).HttpListDemo(ctx, req.(*ListDemoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Demo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HttpListDemo",
			Handler:    _Demo_HttpListDemo_Handler,
		},
	},
